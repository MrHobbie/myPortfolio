jQuery( function($){
	...
	function setNavbarLight() {
		...
		$('.navbar-brand img').attr('src', 'assets/img/devices-header(black-small).png');
	}

	function setNavbarTransparent() {
		$('.navbar').removeClass('navbar-light');
		$('.navbar-brand img').attr('src', 'assets/img/devices-header(1f3553-small).png');
	}
...
//	});
	...
	*/
	...
	//twitterFetcher.fetch( '536575811860443136', 'tweet', 10, true, false, true, 'default');
